...
- 한 명·두 명 지시는 네 캐릭터 중에서 무작위로 고르고 색상 이름은 해당 캐릭터 색으로 표시합니다.
...
- 리듬 패턴 없이 장애물 개수와 좌우 진입 순서만 짧게 예고합니다.
...
- 기본 삼각 장애물과 통나무가 번갈아 나오며 후반에는 빠른 카트도 섞입니다.
...
- 화면의 `다시 준비하기` 버튼은 PC 테스트용 보조 수단으로 계속 사용할 수 있습니다.
