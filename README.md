...
│       ├── sound.js              # assets/sound MP3 재생기(없으면 Web Audio 합성음으로 자동 대체)
...
│   └── sound/                    # 배경음악·게임 통과/게임오버/별/줄넘기 실패 MP3 에셋
├── esp32/
...
- 플레이 중에는 `assets/sound/background_music.mp3`가 반복 재생되고 준비·종료 화면에서는 자동으로 멈춥니다. 우측 상단 소리 버튼으로 배경음악과 효과음을 함께 끄거나 켤 수 있습니다.
